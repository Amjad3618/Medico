...
class MyAddedBloodMobile extends StatefulWidget {
  const MyAddedBloodMobile({Key? key}) : super(key: key);

  @override
  _MyAddedBloodMobileState createState() => _MyAddedBloodMobileState();
}

class _MyAddedBloodMobileState extends State<MyAddedBloodMobile> {
